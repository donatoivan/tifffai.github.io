...
- Purpose
    ...
    - Target Audience
- Design Process
    - Inspirations (convey my personality as a developer)
    - Color Scheme
    - Font Planning
    - Personal Logo
    - Wireframes (for 4 screen sizes including desktop and mobile with details)
    - Screenshots
- Details of Planning Process
    - Trello Board Project Planning & Timelines
    - Git commits with commit messages to reach planned solutions
- Usability Considerations
    - Challenges
        - Tried to cover 5 screen sizes with media queries and wish I had more time to cover more
        - Viewing the capabilities of other websites I am limited by my lack of knowledge of Javascript and can't wait to upgrade my current website as I learn more coding languages
    - Ethical Issues
    - Favorite Parts
- History & Theory on The Internet
    - History of Internet Creation
    - Understanding Relationship of Internet Domains
    - Internet Technologies' Impact
...
I settled on an image of a gorgeous photograph of a long road ahead, and at that moment I felt it was almost poetic and suited my theme perfectly. The road represented this journey I am on to becoming a developer. With this photograph below, I used *Adobe Color CC* to create my initial color palette.

![Color Scheme Checks](/docs/color_scheme.png)

I then proceeded to sample my color combinations and checked the color contrast ratios to match WCAG standards. This was a very difficult process because my main dark orange color (HEX #ED6400) only passes for large text WCAG AA. Thankfully I was only planning to use this accent color on headings so this colour scheme would still work. However, I spent a lot of time tweaking the shade hoping to find an orange tone that is WCAG AAA. But the ones that were, deviated too far from the style aesthetic I wanted for my webpage and was much too jarring and closer to brown than a lively pop of orange color. I even went online to look at other brands that use orange for their logos and color scheme and was really surprised none of them meets WCAG AAA standards. From this, I learnt that orange is a difficult color to use in the future if I wanted to adhere to the WCAG standards perfectly. I wouldn't have expected that considering it's often a color associated with grabbing attention. In the end, I chose an orange with a highest ratio orange shade that still suits the look and feel of the portfolio. Most of my 
<br>

##### Font Selection
Choosing a font was much easier, I knew I wanted to use san-serif style throughout my webpage and wanted to incorporate 2 different fonts. One for the heading, and another for the smaller body of text. I was also sure I wanted to use Google fonts for wide compatibility for users. I looked at some font pairings for inspiration done by others like the panels below, then tried a few styles out myself using my color scheme. With everything visualized, I quickly settled on using Roboto for my headings, and Montserrat for the rest of the text. I think having a clear direction with fonts made the process much more efficient.
![Font Inspirations](/docs/font_inspiration.png)
![Font Pairings](/docs/font_pairings.png)
<br>

##### Personal Logo
Creating the logo was incredibly fun, in fact, it was one of the first things I started doodling around with. I mocked up a few logo designs using my initials, and the letters from my name and created different styles. Below are the mockups of my designs from left to right with some of the earlier ones to settling on 2 main designs that I liked. Afterwards, I also integrated my color palette to try different iterations of them. 

Firstly, the logo on the top right side that looks like two letters with transparency overlay was a further design of the bottom left design. I loved how the simple line of my initials T.F. matched up so well that create an almost hashtag-like symbol. Next, the circle design and very versatile and adaptable. You can spell my full name using just the lines within the circle. In the end, to match the look and feel of my portfolio webpage, the one using just my initials works better than the latter. 
...
On the left, I first started to design for portrait small mobile device first. Also visualised how the interactions from the navigation bar on the left of the top page would interact with the rest of the page. I wanted the navigation bar to stay fixed on the page if it was on the left side, but also tested to see how it would look if I have a navigation bar at the end of each section instead. My final design used the former method having a fixed bar on the left side, accessible throughout the experience. 
![Wireframes](/docs/wireframes.png)
<br>

##### Project Management 
I used Trello to manage the timeline and entire process, it helped me stay on top and prioritize which task I had to tackle first. I also used Git to keep track of all progress saved throughout the project. 
...
## Final Product
I've been very excited and pleased with the final product that's been created. The website takes into consideration a number of screen layouts from varying mobile sizes, to a different orientation, to tablets and laptop screens. Incorporating CSS animation has also been a lot of fun, it's incredible how powerful CSS can be even on its own. 
...
Below are some screenshots of my final website.
