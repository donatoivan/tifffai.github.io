...
# Final Product
I've been very excited and pleased with the final product that's been created. The website takes into consideration a number of screen layouts from varying mobile sizes, to a different orientation, to tablets and laptop screens. Incorporating CSS animation has also been a lot of fun, it's incredible how powerful CSS can be even on its own. The entire process has also been very educational, and gave me new confidence in being able to create something in its entirety from scratch. 
